// Same-origin proxy for Clerk Frontend API.
// Makes session cookies first-party on sparekei.com (survives third-party
// cookie blocking). Adds the headers Clerk requires for proxy attribution.
